    ...
    <React.Fragment>
      ...
      <main className=" flex flex-col min-h-screen justify-between h-full w-full overflow-x-hidden pt-16 p-5">
        <div className="relative z-1 h-[70vh] w-[43%] my-auto">
          <div className='p-5 card h-full w-full border-2 shadow-inner bg-[#000000ac] shadow-cyan-200 border-cyan-200 flex flex-row flex-wrap overflow-auto custom gap-10 justify-center'>
            {children}
          </div>
        </div>
        <BottomButton />
