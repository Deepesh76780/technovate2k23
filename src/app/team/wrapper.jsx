    ...
    return (
        <React.Fragment>
            ...
            <main className="flex flex-col md:min-h-screen  h-[100dvh] justify-between w-full overflow-x-hidden pt-16 md:p-5 p-3 ">
                <div className="relative z-1 h-[70vh]  w-full my-auto">
                    ...
                    >
                        <div className=" overflow-y-scroll cus h-full w-full p-2 md:p-5 flex flex-row flex-wrap overflow-auto gap-5 md:gap-10 justify-center place-items-center">
                            {children}
                        </div>
                    </motion.div>
                </div>
