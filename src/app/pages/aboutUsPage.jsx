    ...
    <div className="h-screen relative overflow-hidden w-full">
      <section class="pt-32 pb-32 relative">
        ...
        <h1 class="font-Michroma text-white display-2 text-center relative max-w-[80rem] mx-auto font-bold tracking-widest bg-[#14101063] p-10 border-2 border-x-slate-50 rounded-xl">
          ...
          enchanting month of November, this grand affair unfurls a spectacle of
          brilliance that encompasses enthralling Coding competitions,
          ...
          canvas. In this year's edition, as the scale of the event expands and
          the anticipation grows, we envisage an even greater turnout of over
          7000+ participants. At its core, Technovate is a dynamic oasis that
          empowers students to celebrate their skills and passions in the fields
          of their dreams. "
        </h1>
      </section>
