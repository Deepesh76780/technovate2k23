    ...
    <div className="relative overflow-hidden w-full">
      <section class="lg:pt-32 lg:pb-32 pb-20 pt-20 relative">
        ...
        <div className="w-full flex flex-col lg:gap-28 gap-14">
          <div className=' w-fit border-2 font-cyberway tracking-[0.3em]  shadow-xl rounded-2xl   text-slate-100 lg:text-2xl text-xl display-2 text-center relative max-w-[80rem]  mx-auto font-bold  bg-blackparent p-4 shadow-black '>
            PAST PERFORMERS
          </div>
          <Marquee>
            {
